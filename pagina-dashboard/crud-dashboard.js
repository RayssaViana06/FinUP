...
//CONFIGURAÇÕES
function readConfigMetas() {
    return JSON.parse(localStorage.getItem("configuracoes-pagina-inicial-metas"));
}

function readConfigContas() {
    return JSON.parse(localStorage.getItem("configuracoes-pagina-inicial-contas-a-pagar"));
}

function readConfigLimites() {
    return JSON.parse(localStorage.getItem("configuracoes-pagina-inicial-limites-de-gastos"));
}

function readConfigGastosCategorias() {
    return JSON.parse(localStorage.getItem("configuracoes-pagina-inicial-gastos-por-categoria"));
}